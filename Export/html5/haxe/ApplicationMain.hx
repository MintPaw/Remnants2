...
class ApplicationMain {
	...
	private static function preload() {
		...
		flash.Lib.stage.frameRate = 0;
		// preloader:
		Lib.current.addChild(preloader = new ());
		preloader.onInit();
		
		// assets
		loadSound("assets/sounds/beep.ogg");
		loadSound("assets/sounds/flixel.ogg");
		loadFile("flixel/flixel-ui/img/tab_back.png");
		loadFile("flixel/flixel-ui/img/swatch.png");
		loadFile("flixel/flixel-ui/img/check_box.png");
		loadFile("flixel/flixel-ui/img/box.png");
		loadFile("flixel/flixel-ui/img/finger_big.png");
		loadFile("flixel/flixel-ui/img/radio_dot.png");
		loadFile("flixel/flixel-ui/img/button_toggle.png");
		loadFile("flixel/flixel-ui/img/dropdown_mark.png");
		loadFile("flixel/flixel-ui/img/chrome.png");
		loadFile("flixel/flixel-ui/img/hilight.png");
		loadFile("flixel/flixel-ui/img/check_mark.png");
		loadFile("flixel/flixel-ui/img/tab.png");
		loadFile("flixel/flixel-ui/img/minus_mark.png");
		loadFile("flixel/flixel-ui/img/button_arrow_right.png");
		loadFile("flixel/flixel-ui/img/button_arrow_up.png");
		loadFile("flixel/flixel-ui/img/button_thin.png");
		loadFile("flixel/flixel-ui/img/plus_mark.png");
		loadFile("flixel/flixel-ui/img/button_arrow_left.png");
		loadFile("flixel/flixel-ui/img/radio.png");
		loadFile("flixel/flixel-ui/img/chrome_flat.png");
		loadFile("flixel/flixel-ui/img/chrome_inset.png");
		loadFile("flixel/flixel-ui/img/finger_small.png");
		loadFile("flixel/flixel-ui/img/button_arrow_down.png");
		loadFile("flixel/flixel-ui/img/chrome_light.png");
		loadFile("flixel/flixel-ui/img/invis.png");
		loadFile("flixel/flixel-ui/img/button.png");
		loadBinary("flixel/flixel-ui/xml/defaults.xml");
		loadBinary("flixel/flixel-ui/xml/default_popup.xml");
		loadBinary("flixel/flixel-ui/xml/default_loading_screen.xml");
		loadFile("assets/img/tileset.png");
		loadBinary("assets/cfg/autoexecgame.cfg");
