...
class Expr_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_CSTRING("hscript.Expr"); }
		::String __ToString() const { return HX_CSTRING("Expr.") + tag; }
		...
		static ::hscript::Expr EFunction(Dynamic args,::hscript::Expr e,::String name,::hscript::CType ret);
		...
		static ::hscript::Expr EObject(Dynamic fl);
		...
		static ::hscript::Expr ESwitch(::hscript::Expr e,Dynamic cases,::hscript::Expr defaultExpr);
