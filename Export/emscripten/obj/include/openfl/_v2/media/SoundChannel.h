...
class HXCPP_CLASS_ATTRIBUTES  SoundChannel_obj : public ::openfl::_v2::events::EventDispatcher_obj{
	public:
		...
		SoundChannel_obj();
		Void __construct(Dynamic handle,Float startTime,int loops,::openfl::media::SoundTransform soundTransform);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< SoundChannel_obj > __new(Dynamic handle,Float startTime,int loops,::openfl::media::SoundTransform soundTransform);
