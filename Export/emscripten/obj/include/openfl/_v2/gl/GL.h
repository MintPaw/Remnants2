...
#define INCLUDED_openfl__v2_gl_GL
...
HX_DECLARE_CLASS3(openfl,_v2,gl,GL)
...
class HXCPP_CLASS_ATTRIBUTES  GL_obj : public hx::Object{
	...
	public:
		...
		static Void attachShader( ::openfl::_v2::gl::GLProgram program,::openfl::_v2::gl::GLShader shader);
		static Dynamic attachShader_dyn();

		static Void bindAttribLocation( ::openfl::_v2::gl::GLProgram program,int index,::String name);
		static Dynamic bindAttribLocation_dyn();

		static Void bindBitmapDataTexture( ::openfl::_v2::display::BitmapData texture);
		static Dynamic bindBitmapDataTexture_dyn();

		static Void bindBuffer( int target,::openfl::_v2::gl::GLBuffer buffer);
		static Dynamic bindBuffer_dyn();

		static Void bindFramebuffer( int target,::openfl::_v2::gl::GLFramebuffer framebuffer);
		static Dynamic bindFramebuffer_dyn();

		static Void bindRenderbuffer( int target,::openfl::_v2::gl::GLRenderbuffer renderbuffer);
		static Dynamic bindRenderbuffer_dyn();

		static Void bindTexture( int target,::openfl::_v2::gl::GLTexture texture);
		...
		static Void bufferData( int target,::openfl::_v2::utils::IMemoryRange data,int usage);
		static Dynamic bufferData_dyn();

		static Void bufferSubData( int target,int offset,::openfl::_v2::utils::IMemoryRange data);
		...
		static Void compileShader( ::openfl::_v2::gl::GLShader shader);
		static Dynamic compileShader_dyn();

		static Void compressedTexImage2D( int target,int level,int internalformat,int width,int height,int border,::openfl::_v2::utils::IMemoryRange data);
		static Dynamic compressedTexImage2D_dyn();

		static Void compressedTexSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,::openfl::_v2::utils::IMemoryRange data);
		...
		static ::openfl::_v2::gl::GLBuffer createBuffer( );
		static Dynamic createBuffer_dyn();

		static ::openfl::_v2::gl::GLFramebuffer createFramebuffer( );
		static Dynamic createFramebuffer_dyn();

		static ::openfl::_v2::gl::GLProgram createProgram( );
		static Dynamic createProgram_dyn();

		static ::openfl::_v2::gl::GLRenderbuffer createRenderbuffer( );
		static Dynamic createRenderbuffer_dyn();

		static ::openfl::_v2::gl::GLShader createShader( int type);
		static Dynamic createShader_dyn();

		static ::openfl::_v2::gl::GLTexture createTexture( );
		static Dynamic createTexture_dyn();

		static Void cullFace( int mode);
		static Dynamic cullFace_dyn();

		static Void deleteBuffer( ::openfl::_v2::gl::GLBuffer buffer);
		static Dynamic deleteBuffer_dyn();

		static Void deleteFramebuffer( ::openfl::_v2::gl::GLFramebuffer framebuffer);
		static Dynamic deleteFramebuffer_dyn();

		static Void deleteProgram( ::openfl::_v2::gl::GLProgram program);
		static Dynamic deleteProgram_dyn();

		static Void deleteRenderbuffer( ::openfl::_v2::gl::GLRenderbuffer renderbuffer);
		static Dynamic deleteRenderbuffer_dyn();

		static Void deleteShader( ::openfl::_v2::gl::GLShader shader);
		static Dynamic deleteShader_dyn();

		static Void deleteTexture( ::openfl::_v2::gl::GLTexture texture);
		...
		static Void detachShader( ::openfl::_v2::gl::GLProgram program,::openfl::_v2::gl::GLShader shader);
		...
		static Void framebufferRenderbuffer( int target,int attachment,int renderbuffertarget,::openfl::_v2::gl::GLRenderbuffer renderbuffer);
		static Dynamic framebufferRenderbuffer_dyn();

		static Void framebufferTexture2D( int target,int attachment,int textarget,::openfl::_v2::gl::GLTexture texture,int level);
		...
		static Dynamic getActiveAttrib( ::openfl::_v2::gl::GLProgram program,int index);
		static Dynamic getActiveAttrib_dyn();

		static Dynamic getActiveUniform( ::openfl::_v2::gl::GLProgram program,int index);
		static Dynamic getActiveUniform_dyn();

		static Array< ::Dynamic > getAttachedShaders( ::openfl::_v2::gl::GLProgram program);
		static Dynamic getAttachedShaders_dyn();

		static int getAttribLocation( ::openfl::_v2::gl::GLProgram program,::String name);
		...
		static ::String getProgramInfoLog( ::openfl::_v2::gl::GLProgram program);
		static Dynamic getProgramInfoLog_dyn();

		static int getProgramParameter( ::openfl::_v2::gl::GLProgram program,int pname);
		...
		static ::String getShaderInfoLog( ::openfl::_v2::gl::GLShader shader);
		static Dynamic getShaderInfoLog_dyn();

		static int getShaderParameter( ::openfl::_v2::gl::GLShader shader,int pname);
		...
		static ::String getShaderSource( ::openfl::_v2::gl::GLShader shader);
		...
		static Dynamic getUniform( ::openfl::_v2::gl::GLProgram program,Dynamic location);
		static Dynamic getUniform_dyn();

		static Dynamic getUniformLocation( ::openfl::_v2::gl::GLProgram program,::String name);
		...
		static bool isBuffer( ::openfl::_v2::gl::GLBuffer buffer);
		static Dynamic isBuffer_dyn();

		static bool isEnabled( int cap);
		static Dynamic isEnabled_dyn();

		static bool isFramebuffer( ::openfl::_v2::gl::GLFramebuffer framebuffer);
		static Dynamic isFramebuffer_dyn();

		static bool isProgram( ::openfl::_v2::gl::GLProgram program);
		static Dynamic isProgram_dyn();

		static bool isRenderbuffer( ::openfl::_v2::gl::GLRenderbuffer renderbuffer);
		static Dynamic isRenderbuffer_dyn();

		static bool isShader( ::openfl::_v2::gl::GLShader shader);
		static Dynamic isShader_dyn();

		static bool isTexture( ::openfl::_v2::gl::GLTexture texture);
		static Dynamic isTexture_dyn();

		static Void lineWidth( Float width);
		static Dynamic lineWidth_dyn();

		static Void linkProgram( ::openfl::_v2::gl::GLProgram program);
		...
		static Void readPixels( int x,int y,int width,int height,int format,int type,::openfl::_v2::utils::ByteArray pixels);
		...
		static Void shaderSource( ::openfl::_v2::gl::GLShader shader,::String source);
		...
		static Void texImage2D( int target,int level,int internalformat,int width,int height,int border,int format,int type,::openfl::_v2::utils::ArrayBufferView pixels);
		...
		static Void texSubImage2D( int target,int level,int xoffset,int yoffset,int width,int height,int format,int type,::openfl::_v2::utils::ArrayBufferView pixels);
		...
		static Void useProgram( ::openfl::_v2::gl::GLProgram program);
		static Dynamic useProgram_dyn();

		static Void validateProgram( ::openfl::_v2::gl::GLProgram program);
...
#endif /* INCLUDED_openfl__v2_gl_GL */ 
