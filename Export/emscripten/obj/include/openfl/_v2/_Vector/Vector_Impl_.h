...
#define INCLUDED_openfl__v2__Vector_Vector_Impl_

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(openfl,_v2,_Vector,Vector_Impl_)
namespace openfl{
namespace _v2{
namespace _Vector{
...
class HXCPP_CLASS_ATTRIBUTES  Vector_Impl__obj : public hx::Object{
	...
	public:
		...
		static Dynamic fromHaxeVector( Dynamic value);
		static Dynamic fromHaxeVector_dyn();

		static Dynamic toHaxeVector( Dynamic this1);
...
#endif /* INCLUDED_openfl__v2__Vector_Vector_Impl_ */ 
