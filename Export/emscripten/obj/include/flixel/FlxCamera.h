...
class HXCPP_CLASS_ATTRIBUTES  FlxCamera_obj : public ::flixel::FlxBasic_obj{
	...
	public:
		...
		::flixel::graphics::tile::FlxDrawStackItem _currentStackItem;
		::flixel::graphics::tile::FlxDrawStackItem _headOfDrawStack;
		virtual ::flixel::graphics::tile::FlxDrawStackItem getDrawStackItem( ::flixel::graphics::FlxGraphic ObjGraphics,bool ObjColored,int ObjBlending,hx::Null< bool >  ObjAntialiasing);
		...
		static ::flixel::graphics::tile::FlxDrawStackItem _storageHead;
};
