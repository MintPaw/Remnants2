...
class HXCPP_CLASS_ATTRIBUTES  FlxTimer_obj : public hx::Object{
	public:
		...
		FlxTimer_obj();
		Void __construct(Dynamic Time,Dynamic OnComplete,hx::Null< int >  __o_Loops);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< FlxTimer_obj > __new(Dynamic Time,Dynamic OnComplete,hx::Null< int >  __o_Loops);
