...
bool HasNodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.HasNodeAccess","resolve",0x2b3f8e2c,"haxe.xml._Fast.HasNodeAccess.resolve","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",87,0x60a2153a)
	HX_STACK_THIS(this)
