...
int EnumValueMap_obj::compareArg( Dynamic v1,Dynamic v2){
	HX_STACK_FRAME("haxe.ds.EnumValueMap","compareArg",0xcee2e55c,"haxe.ds.EnumValueMap.compareArg","C:\\HaxeToolkit\\haxe\\std/haxe/ds/EnumValueMap.hx",53,0x67888762)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v1,"v1")
	HX_STACK_ARG(v2,"v2")
	HX_STACK_LINE(53)
