...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_FRAME("Type","createEnum",0xd8d56d31,"Type.createEnum","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",91,0x00143afe)
	HX_STACK_ARG(e,"e")
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	HX_STACK_FRAME("Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",101,0x00143afe)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(101)
...
::String Type_obj::enumConstructor( Dynamic e){
	HX_STACK_FRAME("Type","enumConstructor",0x45f8fde5,"Type.enumConstructor","C:\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",133,0x00143afe)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(133)
	return e->__Tag();
}
