...
HX_STACK_THIS(this)
{
	...
	this->loaderURL = null();
	HX_STACK_LINE(46)
	this->addEventListener(::openfl::_v2::events::Event_obj::COMPLETE,this->this_onComplete_dyn(),null(),null(),null());
}
;
	return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.LoaderInfo","this_onComplete",0xee737589,"openfl._v2.display.LoaderInfo.this_onComplete","openfl/_v2/display/LoaderInfo.hx",104,0x9729af9d)
		HX_STACK_THIS(this)
...
::openfl::_v2::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_FRAME("openfl._v2.display.LoaderInfo","get_bytes",0x3f7511d2,"openfl._v2.display.LoaderInfo.get_bytes","openfl/_v2/display/LoaderInfo.hx",118,0x9729af9d)
	HX_STACK_THIS(this)
	HX_STACK_LINE(118)
	return this->data;
}
...
::openfl::_v2::display::LoaderInfo LoaderInfo_obj::create( ::openfl::_v2::display::Loader loader){
	HX_STACK_FRAME("openfl._v2.display.LoaderInfo","create",0xf203efec,"openfl._v2.display.LoaderInfo.create","openfl/_v2/display/LoaderInfo.hx",51,0x9729af9d)
