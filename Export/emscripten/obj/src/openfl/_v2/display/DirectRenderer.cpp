...
::String type = __o_type.Default(HX_CSTRING("DirectRenderer"));
{
	...
	HX_STACK_LINE(15)
	Dynamic _g1 = ::openfl::_v2::display::DirectRenderer_obj::lime_direct_renderer_create();		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(15)
	super::__construct(_g1,type);

	HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_1_1,Array< ::Dynamic >,_g)
	Void run(Dynamic _){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/_v2/display/DirectRenderer.hx",17,0x72da2912)
		HX_STACK_ARG(_,"_")
		{
			HX_STACK_LINE(17)
			::openfl::_v2::display::DirectRenderer_obj::lime_direct_renderer_set(_g->__get((int)0).StaticCast< ::openfl::_v2::display::DirectRenderer >()->__handle,_g->__get((int)0).StaticCast< ::openfl::_v2::display::DirectRenderer >()->__onRender_dyn());
		}
		return null();
	}
	...
	HX_STACK_LINE(17)
	this->addEventListener(::openfl::_v2::events::Event_obj::ADDED_TO_STAGE, Dynamic(new _Function_1_1(_g)),null(),null(),null());

	HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_1_2,Array< ::Dynamic >,_g)
	Void run(Dynamic _){
		HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","openfl/_v2/display/DirectRenderer.hx",18,0x72da2912)
		HX_STACK_ARG(_,"_")
		{
			HX_STACK_LINE(18)
			::openfl::_v2::display::DirectRenderer_obj::lime_direct_renderer_set(_g->__get((int)0).StaticCast< ::openfl::_v2::display::DirectRenderer >()->__handle,null());
		}
		return null();
	}
	HX_END_LOCAL_FUNC1((void))
	...
	HX_STACK_LINE(18)
	this->addEventListener(::openfl::_v2::events::Event_obj::REMOVED_FROM_STAGE, Dynamic(new _Function_1_2(_g)),null(),null(),null());
}
;
	return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.DirectRenderer","render",0x6c3ef9bb,"openfl._v2.display.DirectRenderer.render","openfl/_v2/display/DirectRenderer.hx",23,0x72da2912)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.display.DirectRenderer","__onRender",0xab7bf9da,"openfl._v2.display.DirectRenderer.__onRender","openfl/_v2/display/DirectRenderer.hx",32,0x72da2912)
		HX_STACK_THIS(this)
		HX_STACK_ARG(rect,"rect")
		HX_STACK_LINE(32)
