...
{
		HX_STACK_FRAME("openfl._v2.display.MovieClip","gotoAndPlay",0xf55955fd,"openfl._v2.display.MovieClip.gotoAndPlay","openfl/_v2/display/MovieClip.hx",38,0xe6b47bbe)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.display.MovieClip","gotoAndStop",0xf75b180b,"openfl._v2.display.MovieClip.gotoAndStop","openfl/_v2/display/MovieClip.hx",45,0xe6b47bbe)
		HX_STACK_THIS(this)
		HX_STACK_ARG(frame,"frame")
		HX_STACK_ARG(scene,"scene")
	}
...
{
		HX_STACK_FRAME("openfl._v2.display.MovieClip","nextFrame",0x68cbebef,"openfl._v2.display.MovieClip.nextFrame","openfl/_v2/display/MovieClip.hx",52,0xe6b47bbe)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String MovieClip_obj::__getType( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","__getType",0x5bdd4d05,"openfl._v2.display.MovieClip.__getType","openfl/_v2/display/MovieClip.hx",61,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(61)
...
{
		HX_STACK_FRAME("openfl._v2.display.MovieClip","play",0x841f305f,"openfl._v2.display.MovieClip.play","openfl/_v2/display/MovieClip.hx",66,0xe6b47bbe)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.MovieClip","prevFrame",0xacdd71ef,"openfl._v2.display.MovieClip.prevFrame","openfl/_v2/display/MovieClip.hx",73,0xe6b47bbe)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl._v2.display.MovieClip","stop",0x8620f26d,"openfl._v2.display.MovieClip.stop","openfl/_v2/display/MovieClip.hx",80,0xe6b47bbe)
		HX_STACK_THIS(this)
	}
return null();
}
...
int MovieClip_obj::get_currentFrame( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","get_currentFrame",0x47e2c0a8,"openfl._v2.display.MovieClip.get_currentFrame","openfl/_v2/display/MovieClip.hx",94,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(94)
...
::String MovieClip_obj::get_currentFrameLabel( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","get_currentFrameLabel",0x98f65c2c,"openfl._v2.display.MovieClip.get_currentFrameLabel","openfl/_v2/display/MovieClip.hx",95,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(95)
...
::String MovieClip_obj::get_currentLabel( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","get_currentLabel",0xb10e566f,"openfl._v2.display.MovieClip.get_currentLabel","openfl/_v2/display/MovieClip.hx",96,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(96)
...
Array< ::Dynamic > MovieClip_obj::get_currentLabels( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","get_currentLabels",0x3b7d4b24,"openfl._v2.display.MovieClip.get_currentLabels","openfl/_v2/display/MovieClip.hx",97,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(97)
...
int MovieClip_obj::get_framesLoaded( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","get_framesLoaded",0x08b50fbf,"openfl._v2.display.MovieClip.get_framesLoaded","openfl/_v2/display/MovieClip.hx",98,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(98)
...
int MovieClip_obj::get_totalFrames( ){
	HX_STACK_FRAME("openfl._v2.display.MovieClip","get_totalFrames",0xefd66996,"openfl._v2.display.MovieClip.get_totalFrames","openfl/_v2/display/MovieClip.hx",99,0xe6b47bbe)
	HX_STACK_THIS(this)
	HX_STACK_LINE(99)
	return this->__totalFrames;
}
