...
bool lockCenter = __o_lockCenter.Default(false);
	HX_STACK_FRAME("openfl._v2.display.Sprite","startDrag",0x896ceeea,"openfl._v2.display.Sprite.startDrag","openfl/_v2/display/Sprite.hx",23,0xb1331c39)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl._v2.display.Sprite","stopDrag",0x064e1222,"openfl._v2.display.Sprite.stopDrag","openfl/_v2/display/Sprite.hx",34,0xb1331c39)
		HX_STACK_THIS(this)
		HX_STACK_LINE(36)
		::openfl::_v2::display::Stage _g = this->get_stage();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(36)
...
::String Sprite_obj::__getType( ){
	HX_STACK_FRAME("openfl._v2.display.Sprite","__getType",0x2ee33cc4,"openfl._v2.display.Sprite.__getType","openfl/_v2/display/Sprite.hx",45,0xb1331c39)
	HX_STACK_THIS(this)
	HX_STACK_LINE(47)
