...
::openfl::_v2::AssetCache Assets_obj::cache;
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		::openfl::_v2::Assets_obj::initialize();
		HX_STACK_LINE(106)
		if (((  (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))) ? bool(::openfl::_v2::Assets_obj::cache->bitmapData->exists(id)) : bool(false) ))){
			HX_STACK_LINE(108)
			::openfl::_v2::display::BitmapData bitmapData = ::openfl::_v2::Assets_obj::cache->bitmapData->get(id);		HX_STACK_VAR(bitmapData,"bitmapData");
			HX_STACK_LINE(110)
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_v2::AssetType_obj::IMAGE))){
				...
				if ((library->isLocal(symbolName,::openfl::_v2::AssetType_obj::IMAGE))){
					...
					HX_STACK_LINE(130)
					if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
						HX_STACK_LINE(132)
						::openfl::_v2::Assets_obj::cache->bitmapData->set(id,bitmapData);
					}
					HX_STACK_LINE(136)
					return bitmapData;
				}
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		::openfl::_v2::Assets_obj::initialize();
		HX_STACK_LINE(224)
		if (((  (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))) ? bool(::openfl::_v2::Assets_obj::cache->font->exists(id)) : bool(false) ))){
			HX_STACK_LINE(226)
			return ::openfl::_v2::Assets_obj::cache->font->get(id);
		}
		HX_STACK_LINE(230)
		int _g = id.indexOf(HX_CSTRING(":"),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(230)
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_v2::AssetType_obj::FONT))){
				...
				if ((library->isLocal(symbolName,::openfl::_v2::AssetType_obj::FONT))){
					...
					if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
						HX_STACK_LINE(244)
						::openfl::_v2::Assets_obj::cache->font->set(id,font);
					}
					HX_STACK_LINE(248)
					return font;
				}
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		::openfl::_v2::Assets_obj::initialize();
		HX_STACK_LINE(349)
		if (((  (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))) ? bool(::openfl::_v2::Assets_obj::cache->sound->exists(id)) : bool(false) ))){
			HX_STACK_LINE(351)
			::openfl::_v2::media::Sound sound = ::openfl::_v2::Assets_obj::cache->sound->get(id);		HX_STACK_VAR(sound,"sound");
			HX_STACK_LINE(353)
		...
		if (((library != null()))){
			...
			if ((library->exists(symbolName,::openfl::_v2::AssetType_obj::MUSIC))){
				...
				if ((library->isLocal(symbolName,::openfl::_v2::AssetType_obj::MUSIC))){
					...
					if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
						HX_STACK_LINE(375)
						::openfl::_v2::Assets_obj::cache->sound->set(id,sound);
					}
					HX_STACK_LINE(379)
					return sound;
				}
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
			...
			if (((bool((type == ::openfl::_v2::AssetType_obj::IMAGE)) || bool((type == null()))))){
				HX_STACK_LINE(601)
				if ((::openfl::_v2::Assets_obj::cache->bitmapData->exists(id))){
					HX_STACK_LINE(601)
					return true;
				}
			}
			...
			if (((bool((type == ::openfl::_v2::AssetType_obj::FONT)) || bool((type == null()))))){
				HX_STACK_LINE(607)
				if ((::openfl::_v2::Assets_obj::cache->font->exists(id))){
					HX_STACK_LINE(607)
					return true;
				}
			}
			...
			if (((bool((bool((type == ::openfl::_v2::AssetType_obj::SOUND)) || bool((type == ::openfl::_v2::AssetType_obj::MUSIC)))) || bool((type == null()))))){
				HX_STACK_LINE(613)
				if ((::openfl::_v2::Assets_obj::cache->sound->exists(id))){
					HX_STACK_LINE(613)
					return true;
				}
			}
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		::openfl::_v2::Assets_obj::initialize();
		HX_STACK_LINE(711)
		if (((  (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))) ? bool(::openfl::_v2::Assets_obj::cache->bitmapData->exists(id1->__get((int)0))) : bool(false) ))){
			HX_STACK_LINE(713)
			::openfl::_v2::display::BitmapData bitmapData = ::openfl::_v2::Assets_obj::cache->bitmapData->get(id1->__get((int)0));		HX_STACK_VAR(bitmapData,"bitmapData");
			HX_STACK_LINE(715)
			if ((::openfl::_v2::Assets_obj::isValidBitmapData(bitmapData))){
				HX_STACK_LINE(717)
			...
			if ((library->exists(symbolName,::openfl::_v2::AssetType_obj::IMAGE))){
				...
				if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
					...
					Void run(::openfl::_v2::display::BitmapData bitmapData){
						...
						{
							HX_STACK_LINE(736)
							::openfl::_v2::Assets_obj::cache->bitmapData->set(id1->__get((int)0),bitmapData);
							HX_STACK_LINE(737)
							handler1->__GetItem((int)0)(bitmapData).Cast< Void >();
						}
						return null();
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		::openfl::_v2::Assets_obj::initialize();
		HX_STACK_LINE(810)
		if (((  (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))) ? bool(::openfl::_v2::Assets_obj::cache->font->exists(id1->__get((int)0))) : bool(false) ))){
			HX_STACK_LINE(812)
			::openfl::_v2::text::Font _g = ::openfl::_v2::Assets_obj::cache->font->get(id1->__get((int)0));		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(812)
			...
			if ((library->exists(symbolName,::openfl::_v2::AssetType_obj::FONT))){
				...
				if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
					...
					Void run(::openfl::_v2::text::Font font){
						...
						{
							HX_STACK_LINE(829)
							::openfl::_v2::Assets_obj::cache->font->set(id1->__get((int)0),font);
							HX_STACK_LINE(830)
	...
	HX_STACK_ARG(useCache,"useCache")
{
		...
		::openfl::_v2::Assets_obj::initialize();
		HX_STACK_LINE(894)
		if (((  (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))) ? bool(::openfl::_v2::Assets_obj::cache->sound->exists(id1->__get((int)0))) : bool(false) ))){
			HX_STACK_LINE(896)
			::openfl::_v2::media::Sound sound = ::openfl::_v2::Assets_obj::cache->sound->get(id1->__get((int)0));		HX_STACK_VAR(sound,"sound");
			HX_STACK_LINE(898)
			if ((::openfl::_v2::Assets_obj::isValidSound(sound))){
				HX_STACK_LINE(900)
			...
			if ((library->exists(symbolName,::openfl::_v2::AssetType_obj::MUSIC))){
				...
				if (((bool(useCache) && bool(::openfl::_v2::Assets_obj::cache->enabled)))){
					...
					Void run(::openfl::_v2::media::Sound sound){
						...
						{
							HX_STACK_LINE(919)
							::openfl::_v2::Assets_obj::cache->sound->set(id1->__get((int)0),sound);
							HX_STACK_LINE(920)
							handler1->__GetItem((int)0)(sound).Cast< Void >();
						}
						return null();
...
Dynamic Assets_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"cache") ) { cache=inValue.Cast< ::openfl::_v2::AssetCache >(); return inValue; }
		break;
	case 9:
