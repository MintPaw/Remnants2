...
{
HX_STACK_FRAME("flixel.ui.GraphicButton","new",0x5d7eff44,"flixel.ui.GraphicButton.new","openfl/_v2/Assets.hx",1526,0x2846aac8)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1594)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::ui::GraphicButton_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1594)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.ui.GraphicButton"), hx::TCanCast< GraphicButton_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_ui_GraphicButton");
}
