...
{
HX_STACK_FRAME("flixel.ui._FlxButton.FlxButtonEvent","new",0xea40fb69,"flixel.ui._FlxButton.FlxButtonEvent.new","flixel/ui/FlxButton.hx",601,0xc64cf442)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.ui._FlxButton.FlxButtonEvent","destroy",0x72801083,"flixel.ui._FlxButton.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",613,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(614)
		this->callback = null();
		HX_STACK_LINE(617)
		::flixel::system::FlxSound _g = ::flixel::util::FlxDestroyUtil_obj::destroy(this->sound);		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(617)
		this->sound = _g;
	}
return null();
...
{
		HX_STACK_FRAME("flixel.ui._FlxButton.FlxButtonEvent","fire",0x0954508d,"flixel.ui._FlxButton.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",625,0xc64cf442)
		HX_STACK_THIS(this)
		HX_STACK_LINE(626)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.ui._FlxButton.FlxButtonEvent"), hx::TCanCast< FlxButtonEvent_obj> ,sStaticFields,sMemberFields,
