...
Void FlxPool_flixel_math_FlxPoint_obj::__construct(::Class classObj)
{
HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","new",0x4abdd86f,"flixel.util.FlxPool_flixel_math_FlxPoint.new","flixel/util/FlxPool.hx",10,0xdd4de86a)
HX_STACK_THIS(this)
...
hx::ObjectPtr< FlxPool_flixel_math_FlxPoint_obj > FlxPool_flixel_math_FlxPoint_obj::__new(::Class classObj)
{  hx::ObjectPtr< FlxPool_flixel_math_FlxPoint_obj > result = new FlxPool_flixel_math_FlxPoint_obj();
...
::flixel::math::FlxPoint FlxPool_flixel_math_FlxPoint_obj::get( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","get",0x4ab888a5,"flixel.util.FlxPool_flixel_math_FlxPoint.get","flixel/util/FlxPool.hx",29,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(30)
	...
	HX_STACK_LINE(34)
	return this->_pool->__get(_g).StaticCast< ::flixel::math::FlxPoint >();
}
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","put",0x4abf6ade,"flixel.util.FlxPool_flixel_math_FlxPoint.put","flixel/util/FlxPool.hx",40,0xdd4de86a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","putUnsafe",0xf57edda4,"flixel.util.FlxPool_flixel_math_FlxPoint.putUnsafe","flixel/util/FlxPool.hx",54,0xdd4de86a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(54)
		if (((obj != null()))){
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","preAllocate",0x522a790f,"flixel.util.FlxPool_flixel_math_FlxPoint.preAllocate","flixel/util/FlxPool.hx",63,0xdd4de86a)
		HX_STACK_THIS(this)
...
Array< ::Dynamic > FlxPool_flixel_math_FlxPoint_obj::clear( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","clear",0x8762db5c,"flixel.util.FlxPool_flixel_math_FlxPoint.clear","flixel/util/FlxPool.hx",70,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
	this->_count = (int)0;
	HX_STACK_LINE(72)
...
int FlxPool_flixel_math_FlxPoint_obj::get_length( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_math_FlxPoint","get_length",0xb3eaac80,"flixel.util.FlxPool_flixel_math_FlxPoint.get_length","flixel/util/FlxPool.hx",79,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(79)
	return this->_count;
}
...
Dynamic FlxPool_flixel_math_FlxPoint_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic FlxPool_flixel_math_FlxPoint_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(FlxPool_flixel_math_FlxPoint_obj,_pool),HX_CSTRING("_pool")},
	{hx::fsObject /*::Class*/ ,(int)offsetof(FlxPool_flixel_math_FlxPoint_obj,_class),HX_CSTRING("_class")},
	{hx::fsInt,(int)offsetof(FlxPool_flixel_math_FlxPoint_obj,_count),HX_CSTRING("_count")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
Class FlxPool_flixel_math_FlxPoint_obj::__mClass;

void FlxPool_flixel_math_FlxPoint_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.util.FlxPool_flixel_math_FlxPoint"), hx::TCanCast< FlxPool_flixel_math_FlxPoint_obj> ,sStaticFields,sMemberFields,
...
void FlxPool_flixel_math_FlxPoint_obj::__boot()
{
}
