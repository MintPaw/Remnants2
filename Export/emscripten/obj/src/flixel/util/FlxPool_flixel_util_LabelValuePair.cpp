...
{
HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","new",0x9e8bdd4e,"flixel.util.FlxPool_flixel_util_LabelValuePair.new","flixel/util/FlxPool.hx",10,0xdd4de86a)
HX_STACK_THIS(this)
...
::flixel::util::LabelValuePair FlxPool_flixel_util_LabelValuePair_obj::get( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","get",0x9e868d84,"flixel.util.FlxPool_flixel_util_LabelValuePair.get","flixel/util/FlxPool.hx",29,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(30)
	...
	HX_STACK_LINE(34)
	return this->_pool->__get(_g).StaticCast< ::flixel::util::LabelValuePair >();
}
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","put",0x9e8d6fbd,"flixel.util.FlxPool_flixel_util_LabelValuePair.put","flixel/util/FlxPool.hx",40,0xdd4de86a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","putUnsafe",0xa6da53c3,"flixel.util.FlxPool_flixel_util_LabelValuePair.putUnsafe","flixel/util/FlxPool.hx",54,0xdd4de86a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(54)
		if (((obj != null()))){
...
{
		HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","preAllocate",0xa9e6f4ee,"flixel.util.FlxPool_flixel_util_LabelValuePair.preAllocate","flixel/util/FlxPool.hx",63,0xdd4de86a)
		HX_STACK_THIS(this)
...
Array< ::Dynamic > FlxPool_flixel_util_LabelValuePair_obj::clear( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","clear",0xee6315fb,"flixel.util.FlxPool_flixel_util_LabelValuePair.clear","flixel/util/FlxPool.hx",70,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
	this->_count = (int)0;
	HX_STACK_LINE(72)
...
int FlxPool_flixel_util_LabelValuePair_obj::get_length( ){
	HX_STACK_FRAME("flixel.util.FlxPool_flixel_util_LabelValuePair","get_length",0x32969181,"flixel.util.FlxPool_flixel_util_LabelValuePair.get_length","flixel/util/FlxPool.hx",79,0xdd4de86a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(79)
	return this->_count;
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(FlxPool_flixel_util_LabelValuePair_obj,_count),HX_CSTRING("_count")},
	{ hx::fsUnknown, 0, null()}
};
#endif
