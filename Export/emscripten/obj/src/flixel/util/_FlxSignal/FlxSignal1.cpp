...
{
HX_STACK_FRAME("flixel.util._FlxSignal.FlxSignal1","new",0x17c62462,"flixel.util._FlxSignal.FlxSignal1.new","flixel/util/FlxSignal.hx",209,0x3c758c5e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(210)
	super::__construct();
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxSignal1","dispatch1",0x100555b9,"flixel.util._FlxSignal.FlxSignal1.dispatch1","flixel/util/FlxSignal.hx",280,0x3c758c5e)
		HX_STACK_THIS(this)
