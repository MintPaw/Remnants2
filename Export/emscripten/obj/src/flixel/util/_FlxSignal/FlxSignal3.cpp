...
{
HX_STACK_FRAME("flixel.util._FlxSignal.FlxSignal3","new",0x3e934d64,"flixel.util._FlxSignal.FlxSignal3.new","flixel/util/FlxSignal.hx",237,0x3c758c5e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(238)
	super::__construct();
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxSignal3","dispatch3",0x11c22c3d,"flixel.util._FlxSignal.FlxSignal3.dispatch3","flixel/util/FlxSignal.hx",280,0x3c758c5e)
		HX_STACK_THIS(this)
