...
{
HX_STACK_FRAME("flixel.util._FlxSignal.FlxSignal4","new",0xd1f9e1e5,"flixel.util._FlxSignal.FlxSignal4.new","flixel/util/FlxSignal.hx",251,0x3c758c5e)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(252)
	super::__construct();
...
{
		HX_STACK_FRAME("flixel.util._FlxSignal.FlxSignal4","dispatch4",0x92a0977f,"flixel.util._FlxSignal.FlxSignal4.dispatch4","flixel/util/FlxSignal.hx",280,0x3c758c5e)
		HX_STACK_THIS(this)
