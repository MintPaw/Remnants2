...
Void DebuggerFrontEnd_obj::setLayout( ::flixel::system::debug::FlxDebuggerLayout Layout){
{
...
::flixel::system::ui::FlxSystemButton DebuggerFrontEnd_obj::addButton( ::flixel::system::debug::FlxButtonAlignment Alignment,::openfl::_v2::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  __o_ToggleMode,hx::Null< bool >  __o_UpdateLayout){
...
bool DebuggerFrontEnd_obj::set_visible( bool Value){
	HX_STACK_FRAME("flixel.system.frontEnds.DebuggerFrontEnd","set_visible",0xfdfb51d4,"flixel.system.frontEnds.DebuggerFrontEnd.set_visible","flixel/system/frontEnds/DebuggerFrontEnd.hx",156,0x2ebb4b30)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Value,"Value")
	HX_STACK_LINE(156)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(DebuggerFrontEnd_obj,toggleKeys),HX_CSTRING("toggleKeys")},
