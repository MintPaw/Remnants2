...
Void FontDefault_obj::__construct(::String __o_filename,::openfl::_v2::text::FontStyle style,::openfl::_v2::text::FontType type)
{
HX_STACK_FRAME("flixel.system._FlxAssets.FontDefault","new",0x42de48d9,"flixel.system._FlxAssets.FontDefault.new","flixel/system/FlxAssets.hx",21,0xd3ac1356)
HX_STACK_THIS(this)
...
hx::ObjectPtr< FontDefault_obj > FontDefault_obj::__new(::String __o_filename,::openfl::_v2::text::FontStyle style,::openfl::_v2::text::FontType type)
