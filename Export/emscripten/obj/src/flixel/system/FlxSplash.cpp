...
Void FlxSplash_obj::create( ){
{
		...
		this->_sprite = _g1;
		HX_STACK_LINE(61)
		::openfl::_v2::Lib_obj::get_current()->get_stage()->addChild(this->_sprite);
		HX_STACK_LINE(62)
		::openfl::_v2::display::Graphics _g2 = this->_sprite->get_graphics();		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(62)
		this->_gfx = _g2;
		HX_STACK_LINE(64)
		...
		HX_STACK_LINE(67)
		::openfl::_v2::text::TextFormat dtf = ::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEFAULT,(int)16,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(dtf,"dtf");
		HX_STACK_LINE(68)
		...
		HX_STACK_LINE(71)
		::openfl::_v2::Lib_obj::get_current()->get_stage()->addChild(this->_text);
		HX_STACK_LINE(73)
		this->onResize(stageWidth,stageHeight);
		HX_STACK_LINE(76)
		::openfl::_v2::media::Sound _g4;		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(76)
		{
			HX_STACK_LINE(76)
			...
			HX_STACK_LINE(76)
			_g4 = ::openfl::_v2::Assets_obj::getSound((HX_CSTRING("assets/sounds/flixel") + extension),null());
		}
		HX_STACK_LINE(76)
...
Void FlxSplash_obj::onComplete( ::flixel::tweens::FlxTween Tween){
{
		...
		HX_STACK_LINE(192)
		::openfl::_v2::Lib_obj::get_current()->get_stage()->removeChild(this->_sprite);
		HX_STACK_LINE(193)
		::openfl::_v2::Lib_obj::get_current()->get_stage()->removeChild(this->_text);
		HX_STACK_LINE(194)
		{
			HX_STACK_LINE(194)
...
Dynamic FlxSplash_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"_gfx") ) { _gfx=inValue.Cast< ::openfl::_v2::display::Graphics >(); return inValue; }
		break;
	case 5:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::_v2::display::Sprite*/ ,(int)offsetof(FlxSplash_obj,_sprite),HX_CSTRING("_sprite")},
	{hx::fsObject /*::openfl::_v2::display::Graphics*/ ,(int)offsetof(FlxSplash_obj,_gfx),HX_CSTRING("_gfx")},
	{hx::fsObject /*::openfl::_v2::text::TextField*/ ,(int)offsetof(FlxSplash_obj,_text),HX_CSTRING("_text")},
