...
{
HX_STACK_FRAME("flixel.system.GraphicLogo","new",0x8c3a7cd8,"flixel.system.GraphicLogo.new","openfl/_v2/Assets.hx",1526,0x2846aac8)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1594)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::GraphicLogo_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1594)
