...
::String FrameRecord_obj::save( ){
	...
	if (((this->keys != null()))){
		...
		while((true)){
			...
			object = _g1;
			HX_STACK_LINE(76)
			::String _g2 = ::Std_obj::string(object->value);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(76)
			::String _g3 = ((object->code + HX_CSTRING(":")) + _g2);		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(76)
			hx::AddEq(output,_g3);
		}
	}
	...
	if (((this->mouse != null()))){
		HX_STACK_LINE(83)
		::String _g4 = ::Std_obj::string(this->mouse->button);		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(83)
		::String _g5 = ((((this->mouse->x + HX_CSTRING(",")) + this->mouse->y) + HX_CSTRING(",")) + _g4);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(83)
		::String _g6 = (_g5 + HX_CSTRING(","));		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(83)
		::String _g7 = (_g6 + this->mouse->wheel);		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(83)
		hx::AddEq(output,_g7);
	}
	HX_STACK_LINE(86)
