...
Void FlxSystemButton_obj::__construct(::openfl::_v2::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  __o_ToggleMode)
{
...
bool ToggleMode = __o_ToggleMode.Default(false);
{
	...
	if (((Icon != null()))){
		HX_STACK_LINE(57)
		::openfl::_v2::display::Bitmap _g = ::openfl::_v2::display::Bitmap_obj::__new(Icon,null(),null());		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(57)
		this->_icon = _g;
		HX_STACK_LINE(58)
	...
	HX_STACK_LINE(68)
	this->addEventListener(::openfl::_v2::events::MouseEvent_obj::MOUSE_UP,this->onMouseUp_dyn(),null(),null(),null());
	HX_STACK_LINE(69)
...
hx::ObjectPtr< FlxSystemButton_obj > FlxSystemButton_obj::__new(::openfl::_v2::display::BitmapData Icon,Dynamic UpHandler,hx::Null< bool >  __o_ToggleMode)
...
Void FlxSystemButton_obj::changeIcon( ::openfl::_v2::display::BitmapData Icon){
{
...
Void FlxSystemButton_obj::destroy( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(92)
		this->removeEventListener(::openfl::_v2::events::MouseEvent_obj::MOUSE_UP,this->onMouseUp_dyn(),null());
		HX_STACK_LINE(93)
...
Void FlxSystemButton_obj::onMouseUp( ::openfl::_v2::events::MouseEvent E){
{
...
Void FlxSystemButton_obj::onMouseDown( ::openfl::_v2::events::MouseEvent E){
{
...
Void FlxSystemButton_obj::onMouseOver( ::openfl::_v2::events::MouseEvent E){
{
...
Void FlxSystemButton_obj::onMouseOut( ::openfl::_v2::events::MouseEvent E){
{
...
Dynamic FlxSystemButton_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_icon") ) { _icon=inValue.Cast< ::openfl::_v2::display::Bitmap >(); return inValue; }
		break;
	case 7:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_v2::display::Bitmap*/ ,(int)offsetof(FlxSystemButton_obj,_icon),HX_CSTRING("_icon")},
