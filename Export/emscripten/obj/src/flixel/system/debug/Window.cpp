...
bool Closable = __o_Closable.Default(false);
{
	...
	super::__construct();
	HX_STACK_LINE(101)
	::openfl::_v2::geom::Point _g = ::openfl::_v2::geom::Point_obj::__new((int)50,(int)30);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(101)
	this->minSize = _g;
	HX_STACK_LINE(103)
	...
	HX_STACK_LINE(109)
	::openfl::_v2::display::BitmapData _g6 = ::openfl::_v2::display::BitmapData_obj::__new((int)1,(int)2,true,(int)-16777216,null());		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(109)
	::openfl::_v2::display::Bitmap _g7 = ::openfl::_v2::display::Bitmap_obj::__new(_g6,null(),null());		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(109)
	this->_shadow = _g7;
	HX_STACK_LINE(110)
	::openfl::_v2::display::BitmapData _g8 = ::openfl::_v2::display::BitmapData_obj::__new((int)1,(int)1,true,(int)-580952225,null());		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(110)
	::openfl::_v2::display::Bitmap _g9 = ::openfl::_v2::display::Bitmap_obj::__new(_g8,null(),null());		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(110)
	this->_background = _g9;
	HX_STACK_LINE(111)
	::openfl::_v2::display::BitmapData _g10 = ::openfl::_v2::display::BitmapData_obj::__new((int)1,(int)15,true,(int)-1157627904,null());		HX_STACK_VAR(_g10,"_g10");
	HX_STACK_LINE(111)
	...
	HX_STACK_LINE(122)
	::openfl::_v2::text::TextFormat _g14 = ::openfl::_v2::text::TextFormat_obj::__new(::flixel::system::FlxAssets_obj::FONT_DEBUGGER,(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g14,"_g14");
	HX_STACK_LINE(122)
...
Void Window_obj::updateBounds( ::openfl::_v2::geom::Rectangle Bounds){
{
		...
		if (((this->_bounds != null()))){
			HX_STACK_LINE(250)
			::openfl::_v2::geom::Point _g = ::openfl::_v2::geom::Point_obj::__new(this->_bounds->width,this->_bounds->height);		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(250)
			this->maxSize = _g;
		}
		else{
			HX_STACK_LINE(254)
			::openfl::_v2::geom::Point _g1 = ::openfl::_v2::geom::Point_obj::__new(1.79e+308,1.79e+308);		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(254)
			this->maxSize = _g1;
		}
	}
...
Void Window_obj::bound( ){
{
		...
		if (((this->_bounds != null()))){
			...
			HX_STACK_LINE(412)
			{
				...
				HX_STACK_LINE(412)
				Dynamic Min = this->_bounds->get_left();		HX_STACK_VAR(Min,"Min");
				HX_STACK_LINE(412)
				Float _g = this->_bounds->get_right();		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(412)
				Dynamic Max = (_g - this->_width);		HX_STACK_VAR(Max,"Max");
				HX_STACK_LINE(412)
			...
			HX_STACK_LINE(413)
			{
				...
				HX_STACK_LINE(413)
				Dynamic Min = this->_bounds->get_top();		HX_STACK_VAR(Min,"Min");
				HX_STACK_LINE(413)
				Float _g2 = this->_bounds->get_bottom();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(413)
				Dynamic Max = (_g2 - this->_height);		HX_STACK_VAR(Max,"Max");
				HX_STACK_LINE(413)
				Float lowerBound;		HX_STACK_VAR(lowerBound,"lowerBound");
				HX_STACK_LINE(413)
				if (((bool((Min != null())) && bool((Value < Min))))){
		...
		struct _Function_1_1{
			inline static Float Block( hx::ObjectPtr< ::flixel::system::debug::Window_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/Window.hx",422,0xb8dfd4e5)
				{
					...
					HX_STACK_LINE(422)
					Dynamic Min = __this->minSize->x;		HX_STACK_VAR(Min,"Min");
					HX_STACK_LINE(422)
					Dynamic Max = __this->maxSize->x;		HX_STACK_VAR(Max,"Max");
					HX_STACK_LINE(422)
					Float lowerBound;		HX_STACK_VAR(lowerBound,"lowerBound");
					HX_STACK_LINE(422)
					if (((bool((Min != null())) && bool((Value < Min))))){
		...
		struct _Function_1_2{
			inline static Float Block( hx::ObjectPtr< ::flixel::system::debug::Window_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/debug/Window.hx",423,0xb8dfd4e5)
				{
					...
					HX_STACK_LINE(423)
					Dynamic Min = __this->minSize->y;		HX_STACK_VAR(Min,"Min");
					HX_STACK_LINE(423)
					Dynamic Max = __this->maxSize->y;		HX_STACK_VAR(Max,"Max");
					HX_STACK_LINE(423)
					Float lowerBound;		HX_STACK_VAR(lowerBound,"lowerBound");
					HX_STACK_LINE(423)
					if (((bool((Min != null())) && bool((Value < Min))))){
