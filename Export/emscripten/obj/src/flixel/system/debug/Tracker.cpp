...
Void Tracker_obj::__construct(::String Title,::openfl::_v2::display::BitmapData Icon,Dynamic Width,Dynamic Height,Dynamic Resizable,::openfl::_v2::geom::Rectangle Bounds,Dynamic Closable)
{
HX_STACK_FRAME("flixel.system.debug.Tracker","new",0xabada902,"flixel.system.debug.Tracker.new","flixel/system/debug/Tracker.hx",38,0x59950a0f)
HX_STACK_THIS(this)
...
hx::ObjectPtr< Tracker_obj > Tracker_obj::__new(::String Title,::openfl::_v2::display::BitmapData Icon,Dynamic Width,Dynamic Height,Dynamic Resizable,::openfl::_v2::geom::Rectangle Bounds,Dynamic Closable)
