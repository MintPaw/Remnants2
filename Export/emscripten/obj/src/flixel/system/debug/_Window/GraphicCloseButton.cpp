...
{
HX_STACK_FRAME("flixel.system.debug._Window.GraphicCloseButton","new",0x2a72197b,"flixel.system.debug._Window.GraphicCloseButton.new","openfl/_v2/Assets.hx",1526,0x2846aac8)
HX_STACK_THIS(this)
...
Dynamic fillRGBA = __o_fillRGBA.Default(-1);
{
	...
	HX_STACK_LINE(1594)
	::haxe::io::Bytes _g = ::haxe::Resource_obj::getBytes(::flixel::system::debug::_Window::GraphicCloseButton_obj::resourceName);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1594)
...
{  hx::ObjectPtr< GraphicCloseButton_obj > result = new GraphicCloseButton_obj();
...
Dynamic GraphicCloseButton_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicCloseButton_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicCloseButton_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicCloseButton_obj::__mClass;

void GraphicCloseButton_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug._Window.GraphicCloseButton"), hx::TCanCast< GraphicCloseButton_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_system_debug__Window_GraphicCloseButton");
}
