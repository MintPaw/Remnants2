...
::flixel::system::debug::FlxDebuggerLayout FlxDebuggerLayout_obj::BIG;

::flixel::system::debug::FlxDebuggerLayout FlxDebuggerLayout_obj::LEFT;

::flixel::system::debug::FlxDebuggerLayout FlxDebuggerLayout_obj::MICRO;

::flixel::system::debug::FlxDebuggerLayout FlxDebuggerLayout_obj::RIGHT;

::flixel::system::debug::FlxDebuggerLayout FlxDebuggerLayout_obj::STANDARD;

::flixel::system::debug::FlxDebuggerLayout FlxDebuggerLayout_obj::TOP;
...
Dynamic FlxDebuggerLayout_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Class FlxDebuggerLayout_obj::__mClass;
...
hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.system.debug.FlxDebuggerLayout"), hx::TCanCast< FlxDebuggerLayout_obj >,sStaticFields,sMemberFields,
...
{
hx::Static(BIG) = hx::CreateEnum< FlxDebuggerLayout_obj >(HX_CSTRING("BIG"),2);
hx::Static(LEFT) = hx::CreateEnum< FlxDebuggerLayout_obj >(HX_CSTRING("LEFT"),4);
hx::Static(MICRO) = hx::CreateEnum< FlxDebuggerLayout_obj >(HX_CSTRING("MICRO"),1);
hx::Static(RIGHT) = hx::CreateEnum< FlxDebuggerLayout_obj >(HX_CSTRING("RIGHT"),5);
hx::Static(STANDARD) = hx::CreateEnum< FlxDebuggerLayout_obj >(HX_CSTRING("STANDARD"),0);
hx::Static(TOP) = hx::CreateEnum< FlxDebuggerLayout_obj >(HX_CSTRING("TOP"),3);
}
