...
Void QuadPath_obj::destroy( ){
{
		...
		HX_STACK_LINE(44)
		{
			...
			while((true)){
				...
				++(_g);
				HX_STACK_LINE(46)
				::flixel::math::FlxPoint _g2 = ::flixel::util::FlxDestroyUtil_obj::put(point);		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(46)
				point = _g2;
			}
		}
		HX_STACK_LINE(48)
		::flixel::math::FlxPoint _g1 = ::flixel::util::FlxDestroyUtil_obj::put(this->_a);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(48)
		this->_a = _g1;
		HX_STACK_LINE(49)
		::flixel::math::FlxPoint _g2 = ::flixel::util::FlxDestroyUtil_obj::put(this->_b);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(49)
		this->_b = _g2;
		HX_STACK_LINE(50)
		::flixel::math::FlxPoint _g3 = ::flixel::util::FlxDestroyUtil_obj::put(this->_c);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(50)
		this->_c = _g3;
	}
return null();
	...
	HX_STACK_ARG(index,"index")
{
		...
		HX_STACK_LINE(97)
		return this->_points->__get(hx::Mod(index,this->_points->length)).StaticCast< ::flixel::math::FlxPoint >();
	}
}
...
Void QuadPath_obj::update( Float elapsed){
{
		...
		if (((bool(!(this->backward)) && bool((this->_points != null()))))){
			...
			HX_STACK_LINE(129)
			this->_a = this->_points->__get((this->_index * (int)2)).StaticCast< ::flixel::math::FlxPoint >();
			HX_STACK_LINE(130)
			this->_b = this->_points->__get(((this->_index * (int)2) + (int)1)).StaticCast< ::flixel::math::FlxPoint >();
			HX_STACK_LINE(131)
			this->_c = this->_points->__get(((this->_index * (int)2) + (int)2)).StaticCast< ::flixel::math::FlxPoint >();
			HX_STACK_LINE(133)
			...
			if (((this->_points != null()))){
				...
				td = (Float(((this->scale - td))) / Float(tt));
				HX_STACK_LINE(153)
				this->_a = this->_points->__get(((this->_index * (int)2) + (int)2)).StaticCast< ::flixel::math::FlxPoint >();
				HX_STACK_LINE(154)
				this->_b = this->_points->__get(((this->_index * (int)2) + (int)1)).StaticCast< ::flixel::math::FlxPoint >();
				HX_STACK_LINE(155)
				this->_c = this->_points->__get((this->_index * (int)2)).StaticCast< ::flixel::math::FlxPoint >();
				HX_STACK_LINE(157)
				this->x = ((((this->_a->x * (((int)1 - td))) * (((int)1 - td))) + (((this->_b->x * (int)2) * (((int)1 - td))) * td)) + ((this->_c->x * td) * td));
				HX_STACK_LINE(158)
				this->y = ((((this->_a->y * (((int)1 - td))) * (((int)1 - td))) + (((this->_b->y * (int)2) * (((int)1 - td))) * td)) + ((this->_c->y * td) * td));
...
Void QuadPath_obj::updatePath( ){
{
		...
		while((true)){
			...
			j = (i * (int)2);
			HX_STACK_LINE(184)
			this->_curveD[i] = this->getCurveLength(this->_points->__get(j).StaticCast< ::flixel::math::FlxPoint >(),this->_points->__get((j + (int)1)).StaticCast< ::flixel::math::FlxPoint >(),this->_points->__get((j + (int)2)).StaticCast< ::flixel::math::FlxPoint >());
			HX_STACK_LINE(185)
...
Float QuadPath_obj::getCurveLength( ::flixel::math::FlxPoint start,::flixel::math::FlxPoint control,::flixel::math::FlxPoint finish){
	...
	HX_STACK_LINE(202)
	::flixel::math::FlxPoint a;		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(202)
	{
		HX_STACK_LINE(202)
	...
	HX_STACK_LINE(203)
	::flixel::math::FlxPoint b;		HX_STACK_VAR(b,"b");
	HX_STACK_LINE(203)
	{
		HX_STACK_LINE(203)
		Float X = (int)0;		HX_STACK_VAR(X,"X");
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(QuadPath_obj,_a),HX_CSTRING("_a")},
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(QuadPath_obj,_b),HX_CSTRING("_b")},
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(QuadPath_obj,_c),HX_CSTRING("_c")},
	{ hx::fsUnknown, 0, null()}
};
#endif
