...
Void LinearPath_obj::destroy( ){
{
		...
		HX_STACK_LINE(48)
		::flixel::math::FlxPoint _g1 = ::flixel::util::FlxDestroyUtil_obj::put(this->_last);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(48)
		this->_last = _g1;
		HX_STACK_LINE(49)
		::flixel::math::FlxPoint _g2 = ::flixel::util::FlxDestroyUtil_obj::put(this->_prevPoint);		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(49)
		this->_prevPoint = _g2;
		HX_STACK_LINE(50)
		::flixel::math::FlxPoint _g3 = ::flixel::util::FlxDestroyUtil_obj::put(this->_nextPoint);		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(50)
		this->_nextPoint = _g3;
	}
return null();
	...
	HX_STACK_ARG(index,"index")
{
		...
		HX_STACK_LINE(95)
		return this->points->__get(hx::Mod(index,this->points->length)).StaticCast< ::flixel::math::FlxPoint >();
	}
}
...
Void LinearPath_obj::update( Float elapsed){
{
		...
		if ((!(this->backward))){
			...
			HX_STACK_LINE(132)
			this->_prevPoint = this->points->__get(this->_index).StaticCast< ::flixel::math::FlxPoint >();
			HX_STACK_LINE(133)
			this->_nextPoint = this->points->__get((this->_index + (int)1)).StaticCast< ::flixel::math::FlxPoint >();
			HX_STACK_LINE(134)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(LinearPath_obj,_last),HX_CSTRING("_last")},
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(LinearPath_obj,_prevPoint),HX_CSTRING("_prevPoint")},
	{hx::fsObject /*::flixel::math::FlxPoint*/ ,(int)offsetof(LinearPath_obj,_nextPoint),HX_CSTRING("_nextPoint")},
	{ hx::fsUnknown, 0, null()}
};
#endif
