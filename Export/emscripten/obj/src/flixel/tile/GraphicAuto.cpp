...
{
HX_STACK_FRAME("flixel.tile.GraphicAuto","new",0x7549f89b,"flixel.tile.GraphicAuto.new","openfl/_v2/Assets.hx",1526,0x2846aac8)
HX_STACK_THIS(this)
...
{  hx::ObjectPtr< GraphicAuto_obj > result = new GraphicAuto_obj();
...
Dynamic GraphicAuto_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic GraphicAuto_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 12:
...
void GraphicAuto_obj::__GetFields(Array< ::String> &outFields)
{
...
Class GraphicAuto_obj::__mClass;

void GraphicAuto_obj::__register()
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("flixel.tile.GraphicAuto"), hx::TCanCast< GraphicAuto_obj> ,sStaticFields,sMemberFields,
...
{
	resourceName= HX_CSTRING("__ASSET__:bitmap_flixel_tile_GraphicAuto");
}
