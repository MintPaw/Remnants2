...
{
HX_STACK_FRAME("flixel.group.FlxTypedGroupIterator","new",0xa7153fe6,"flixel.group.FlxTypedGroupIterator.new","flixel/group/FlxGroup.hx",828,0x1e89d58e)
HX_STACK_THIS(this)
...
Dynamic FlxTypedGroupIterator_obj::next( ){
	HX_STACK_FRAME("flixel.group.FlxTypedGroupIterator","next",0x8b82aaad,"flixel.group.FlxTypedGroupIterator.next","flixel/group/FlxGroup.hx",837,0x1e89d58e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(837)
	if ((this->hasNext())){
		HX_STACK_LINE(837)
...
bool FlxTypedGroupIterator_obj::hasNext( ){
	HX_STACK_FRAME("flixel.group.FlxTypedGroupIterator","hasNext",0x559d4ff3,"flixel.group.FlxTypedGroupIterator.hasNext","flixel/group/FlxGroup.hx",841,0x1e89d58e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(842)
	while((true)){
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::flixel::group::FlxTypedGroupIterator_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/group/FlxGroup.hx",842,0x1e89d58e)
				{
