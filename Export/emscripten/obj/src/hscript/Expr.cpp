...
::hscript::Expr  Expr_obj::ESwitch(::hscript::Expr e,Dynamic cases,::hscript::Expr defaultExpr)
	{ return hx::CreateEnum< Expr_obj >(HX_CSTRING("ESwitch"),23,hx::DynamicArray(0,3).Add(e).Add(cases).Add(defaultExpr)); }
...
int Expr_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_CSTRING("ESwitch")) return 23;
